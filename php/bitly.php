 ...
 */
define('bitlyKey', 'R_f3912b8bcf1645a481b4c2839a93a4b9');

/**
 * The bitlyLogin assigned to your bit.ly account. (http://bit.ly/a/account)
 */
define('bitlyLogin' , 'telemedellin');

/**
 * The client_id assigned to your OAuth app. (http://bit.ly/a/account)
 */
define('bitly_clientid' , 'b2c4128fcca3f3a6c9db742b3c7e0d2b0c7d5e7d');

/**
 * The client_secret assigned to your OAuth app. (http://bit.ly/a/account)
 */
define('bitly_secret' , '16b48f4d6053dfecb4367cc5ce4c16f520c355b6');
...
function bitly_v3_shorten($longUrl, $domain = '', $x_login = '', $x_apiKey = '') {
  ...
  if (isset($output->{'data'}->{'hash'})) {
    ...
    //echo '<script>console.log("'.$result['url'].'")</script>';
  }else{
    echo '<script>console.log("NO: '.$url.'")</script>';
  }
  return $result;
}
